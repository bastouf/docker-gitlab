...
# registry.bast.me/bastouf/docker-gitlab:12.10.6
...
```bash
docker pull registry.bast.me/bastouf/docker-gitlab:12.10.6
```
...
docker run --name gitlab -d [OPTIONS] \
    registry.bast.me/bastouf/docker-gitlab:12.10.6 app:sanitize
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    registry.bast.me/bastouf/docker-gitlab:12.10.6 app:rake gitlab:backup:create
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    registry.bast.me/bastouf/docker-gitlab:12.10.6 app:rake db:setup
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    registry.bast.me/bastouf/docker-gitlab:12.10.6 app:rake gitlab:backup:restore
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    registry.bast.me/bastouf/docker-gitlab:12.10.6 app:rake gitlab:backup:restore BACKUP=1417624827
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    registry.bast.me/bastouf/docker-gitlab:12.10.6 app:rake gitlab:env:info
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    registry.bast.me/bastouf/docker-gitlab:12.10.6 app:rake gitlab:import:repos
```
...
> **Note**
>
> Upgrading to `registry.bast.me/bastouf/docker-gitlab:12.10.6` from `registry.bast.me/bastouf/docker-gitlab:7.x.x` can cause issues. It is therefore required that you first upgrade to `registry.bast.me/bastouf/docker-gitlab:8.0.5-1` before upgrading to `registry.bast.me/bastouf/docker-gitlab:8.1.0` or higher.
...
```bash
docker run --name gitlab -d [OPTIONS] registry.bast.me/bastouf/docker-gitlab:12.10.6
```
